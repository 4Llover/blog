...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片
		desktop: [
			"assets/images/DesktopWallpaper/bg-custom.png",
			"assets/images/DesktopWallpaper/wp-custom.png",
		],
		// 移动背景图片
		mobile: [
			"assets/images/MobileWallpaper/bg-mobile-custom.png",
			"assets/images/MobileWallpaper/wp-mobile-custom.png",
		],
		// 背景视频播放地址
